    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-form">
                ...
                <!-- <h4 class="hero-subtitle">Holiday finder</h4> -->
                <h4 class="hero-subtitle"><?php echo CFS()->get( 'field' ); ?></h4>
                <form >
    ...
    <div class="container">
        <div class="section-content">
            <div class="section-img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/explore.jpg" alt="">
            </div>
        ...
        <div class="features-content">
            ...
            <div class="features-cards">
                <div class="feature-card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features/raja-ampat.jpg" alt="" class="feature-img">
                ...
                <div class="feature-card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features/fanjingshan.jpg" alt="" class="feature-img">
                    <div class="feature-card-desc">
                ...
                <div class="feature-card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features/vevey.jpg" alt="" class="feature-img">
                    <div class="feature-card-desc">
                ...
                <div class="feature-card">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features/skadar.jpg" alt="" class="feature-img">
                    <div class="feature-card-desc">
...
<section class="guides">
    <div class="container">
        <div class="section-content">
            ...
            <div class="section-img">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/guides.jpg" alt="">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="testimonial-list">
                <div class="testimonial-item active">
                    ...
                    <div class="testimonial-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonial-1.jpg" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonial-2.jpg" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="testimonial-text">
                    ...
                    <div class="testimonial-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonial-3.jpg" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="testimonial-text">
                    ...
                    <div class="testimonial-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonial-4.jpg" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="testimonial-text">
                    ...
                    <div class="testimonial-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonial-5.jpg" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="testimonial-text">
                    ...
                    <div class="testimonial-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonials/testimonial-6.jpg" alt="">
                    </div>
                </div>
                <div class="direction">
...
<section class="trendings">
    <div class="container">
        <div class="trendings-content">
            ...
            <div class="stories">
                <div class="story">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/stories/story-1.jpg" alt="" class="story-img">
                ...
                <div class="story">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/stories/story-2.jpg" alt="" class="story-img">
                ...
                <div class="story">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/stories/story-3.jpg" alt="" class="story-img">
                ...
                <div class="story">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/stories/story-4.jpg" alt="" class="story-img">
